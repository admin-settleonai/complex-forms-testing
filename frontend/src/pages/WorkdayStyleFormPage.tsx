    ...
    const syncFromTarget = (
      ...
      setFormData((prev) => {
        if (prev[fieldName] !== value) {
          console.log(
            `[WorkdayForm] External change detected: ${fieldName} = ${value}`,
          );
    ...
    <div className="max-w-6xl mx-auto py-8">
      <div className="bg-white shadow rounded-lg p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">
          Workday Style Application Form
        </h1>
        <p className="text-gray-600 mb-8">
          This form demonstrates Workday-style patterns with dynamic dropdowns,
          hierarchical fields, and ARIA attributes.
        </p>
